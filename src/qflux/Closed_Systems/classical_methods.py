...
class QFlux_CS:
    '''
        ...
        ----------
        n_basis : int
            Number of states to include in the chosen representation. If basis
        ...
        xo : float, optional
            Defines the displacement of the initial state in the position
        ...
        mass : float, optional
            Defines the mass of the particle/system of interest.
            Default is 1.0 au.
    ...
    def __init__(self, n_basis=128, xo=1.0, po=0.0, mass=1.0, omega=1.0):
    ...
    def _get_xgrid(self, x_min, x_max):
        '''
        Populate the `self.x_grid` and `self.dx` attributes. This functions
    ...
    def _get_pgrid(self, x_min, x_max, reorder=True):
        '''
        Populate the `self.p_grid` and `self.dp` attributes. This functions
        ...
        x_max : float
            Maximum value of x-coordinates
        reorder : bool
            Boolean flag to determine whether points should be reordered to be
    ...
    def set_coordinate_operators(self, x_min=-7., x_max=7., reorder_p=True):
        '''
    ...
    def _set_hamiltonian_grid(self, potential_type='harmonic', **kwargs):
    ...
    def _set_hamiltonian_qt(self, potential_type='harmonic', **kwargs):
        if potential_type == 'harmonic':
    ...
    def set_hamiltonian(self, potential_type='harmonic', **kwargs):
        '''
        Function to define Hamiltonian.
        TODO: add the option for user-defined functions with arguments
        ...
        potential_type : str
            ...
            Note: You can manually define your potential energy using...
            (insert explanation/example of user-defined potential)

            TODO: Add **kwargs to expose parameters for the quartic potential,
            if not given we can use the default.
        '''
    ...
    def set_H_grid_with_custom_potential(self, custom_function, **kwargs):
        '''
        First attempt at providing functionality for user-defined potentials.
    ...
    def set_H_op_with_custom_potential(self, custom_function, **kwargs):
        '''
        First attempt at providing functionality for user-defined potentials.
    ...
    def set_initial_state(self):
        ...
        normalization = (self.mass*self.omega/np.pi/self.hbar)**(0.25)
        exponential = np.exp(-1 * (self.mass * self.omega / self.hbar / 2) *
    ...
    def custom_grid_state_initialization(self, function_name, **kwargs):
        self.psio_grid = function_name(**kwargs)
        return


    def custom_ladder_state_initialization(self, function_name, **kwargs):
        self.psio_op = function_name(**kwargs)


    def set_propagation_time(self, total_time, n_tsteps):
        '''
    ...
    def propagate_qt(self, solver_options=None):
        '''
        ...
        propagation_method : str
            The propagation method used for evolving the state.
            propagation_method='Qutip' uses qutip.sesolve, and one can provide
            additional solver_options to pass to that function.
            propagation_method='SOFT' uses the Split-Operator Fourier Transform
            method
        ...
        Returns
        ----------
        self.dynamics_results : array-like
        '''
    ...
    def propagate_SOFT(self):
        ...
        Returns
        ----------
        self.dynamics_results_grid : array-like
        '''
